...
<form:form action="register" id="reg" method="post" commandName="user" autocomplete="on">
    ...
    <div class="form-group">
      ...
      <form:input path="emailid" type="email" class="form-control" id="emailid" placeholder="Enter your email" required="true"/>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <form:input path="username" class="form-control" id="username" placeholder="Enter your username" required="true"/>
    </div>
    <div class="form-group">
      <label for="pwd">Password</label>
      <form:input path="password"  type="password" class="form-control" id="password" placeholder="Enter password" maxlength="6" required="true"/>
