...
<table  class="table table-bordred table-striped">
	...
	<tbody >
	<tr ng-repeat="sup in sups | filter : searchbox">
	...
	<td>{{sup.address}}</td>
	<td>{{sup.products}}</td>
	<td><a href="edit2?supid={{sup.id}}">Edit</a></td>
	<td><a href="del2?supid={{sup.id}}">Delete</a></td>
	</tr>
	</tbody>
</table>
...
myapp.controller("Suppliercontroller", function($scope,$http){
	$scope.sups=suppliers;
});
</script>
</body>
</html>